...
export const articlesData = [
  {
    ...
    category: 'Expérience',
    readTime: '5 min',
    tags: ['intégration', 'entreprise', 'premiers-jours']
  },
  {
    id: 'difficultes',
    ...
    category: 'Technique',
    readTime: '7 min',
    tags: ['difficultés', 'solutions', 'problèmes']
  },
  {
    id: 'missions',
    ...
    category: 'Projets',
    readTime: '8 min',
    tags: ['missions', 'projets', 'technique']
  },
  {
    id: 'competences',
    ...
    category: 'Formation',
    readTime: '6 min',
    tags: ['compétences', 'formation', 'développement']
  },
  {
    id: 'actualite',
    ...
    category: 'Veille',
    readTime: '4 min',
    tags: ['veille', 'actualité', 'technologies']
  },
  {
    id: 'bilan-stage',
    ...
    category: 'Bilan',
    readTime: '10 min',
    tags: ['bilan', 'réflexion', 'expérience']
  }
];
